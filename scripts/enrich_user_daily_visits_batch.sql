    ...
    LOOP
        ...
        SET platform = CASE
            ...
            device_type = CASE
                ...
                WHEN user_agent LIKE 'Tchap X%iOS%' THEN 'Tchap iOS X'
                WHEN user_agent LIKE 'Tchap/__.%iOS%' THEN 'Tchap iOS X'
                ...
                WHEN user_agent LIKE 'Tchap/__.%NEO%' THEN 'Tchap Android X NEO'
                WHEN user_agent LIKE 'Tchap%NEO%' THEN 'Tchap Android NEO'
                WHEN user_agent LIKE 'Tchap X%Android%' THEN 'Tchap Android X'
                WHEN user_agent LIKE 'Tchap/__.%Android%' THEN 'Tchap Android X'
                WHEN user_agent LIKE 'Tchap beta%Android%' THEN 'Tchap Android X'
