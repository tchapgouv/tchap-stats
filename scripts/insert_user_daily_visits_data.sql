...
CREATE TEMPORARY TABLE user_daily_visits_temp (user_id VARCHAR, device_id VARCHAR, visits INTEGER, user_agent VARCHAR, domain VARCHAR, instance VARCHAR, visit_ts timestamp with time zone);
